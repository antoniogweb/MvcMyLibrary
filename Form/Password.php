...
{
	public $fill = false; //true or false: fill or not the entry
	...
	public function render($value = null)
	{
		...
		{
			$returnString .= Html_Form::password($this->entryName, $entryValue, $this->className, $this->idName, $this->attributes);
		}
