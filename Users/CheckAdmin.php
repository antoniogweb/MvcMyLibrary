...
// 			print_r($row);
			...
			$row=$this->_db->select($this->_usersTable.','.$this->_sessionsTable,$this->_usersTable.'.'.self::$idUserFieldName.','.self::$usernameFieldName.',token,user_agent,'.$this->_sessionsTable.'.creation_date',$this->_usersTable.".".self::$idUserFieldName."=".$this->_sessionsTable.".".self::$idUserFieldName." and uid='".$this->uid."'",null,null,null,array(),array(),array(),false);
